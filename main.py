...
class runBot(QDialog):
    def __init__(self):
        ...
        self.startButton.clicked.connect(self.findfirstlinks)
    ...
    def findfirstlinks(self):
        ...
        if self.p is None:  # No process running.
            ...
            self.p.start("python", [self.get_path('scripts\\linksOrganisor.py')])
    ...
    def process_finished(self):
        ...
        self.ContinueButton.clicked.connect(self.findfirstlink)

    def findfirstlink(self):
        runbotwo = runBotwo()
        widget.addWidget(runbotwo)
        widget.setCurrentIndex(widget.currentIndex()+1)
...
class runBotwo(QDialog):
    def __init__(self):
        super(runBotwo, self).__init__()
        loadUi(self.get_path("UIFiles\\runbot.ui"), self)
        self.startButton.hide()
        self.ContinueButton.hide()
        self.editArea.setReadOnly(True)
